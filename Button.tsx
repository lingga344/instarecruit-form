...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-gradient-to-r from-instagram-purple to-instagram-end text-white hover:opacity-90 shadow-lg shadow-instagram-end/20 focus:ring-instagram-purple",
    secondary: "bg-white text-gray-900 border border-gray-200 hover:bg-gray-50 focus:ring-gray-200",
    outline: "border-2 border-instagram-purple text-instagram-purple hover:bg-instagram-purple/5 focus:ring-instagram-purple",
